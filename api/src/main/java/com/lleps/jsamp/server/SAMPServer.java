 ...
 * @author spell
 */
public abstract class SAMPServer {
    /**
     * THIS means a static reference to this object, which is needed to make all SAMPServer methods static.
     */
    private static SAMPServer THIS;
    ...
    /**
     * Called by MainCallbackListener, when SAMPServer instance is successfully created.
    ...
    /**
     * Set SAMPServer weather. Will affect all worlds that inherits weather.
    ...
    /**
     * Set SAMPServer time. Will affect all worlds that inherits time.
    ...
    /**
     * To make a world receive time and weather updates from SAMPServer.
     * @param world world.
     */
