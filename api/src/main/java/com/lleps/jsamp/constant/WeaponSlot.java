...
public enum WeaponSlot
{
    ...
    WeaponSlot(int slotId, String typeName) {
        this.slotId = slotId;
    ...
    public static WeaponSlot getById(int id) {
        Map.Entry<Integer, WeaponSlot> slot = VALUES.entrySet().stream()
                .filter(integerWeaponSlotEntry -> integerWeaponSlotEntry.getKey() == id)
